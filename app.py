...
Big Data Engineering,DEVOPS, Data Analyst, Your task is to review 
the provided resume against the job description for these profiles.

Please share your professional evaluation on whether the candidate's profile aligns with these role.
...
#input_prompt2 = 
"""
You are an Technical Human Resource Manager with expertise in any one job role from Data Science,Full stack web development, 
Big Data Engineering,DEVOPS, Data Analyst,
your role is to scrutinize the resume in light of the job description provided.

Share your insights on the candidate's suitability for the role from an HR perspective.

Additionally, offer advice on enhancing the candidate's skills and identify area
"""
...
Big Data Engineering,DEVOPS, Data Analyst and and deep ATS functionality,
...
if submit1:
    if uploaded_file is not None:
        ...
        response=get_gemini_responce(input_prompt1,pdf_content, input_text)
    ...
    if uploaded_file is not None:
        pdf_content = input_pdf_setup(uploaded_file)
        response=get_gemini_responce(input_prompt3,pdf_content, input_text)
        st.subheader("The Response is")
        st.write(response)
    else:
        st.write("Please upload the resume")